...
const uiGroups = Ganymede.uiGroups;
const warning = `" WARNING: Do not edit this file directly - it is built from the src directory`;
...
let g:airline#themes#ganymede#palette.accents = {'red': [ "${
